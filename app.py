...
topic = st.text_input("Enter a topic (e.g., Photosynthesis, Gravity, etc.) / विषय दर्ज करें")
    ...
    if language == "English":
        ...
        if mode == "Topic Explanation":
            ...
            prompt = (
                ...
                f"प्रत्येक प्रश्न में 4 विकल्प (A, B, C, D) होने चाहिए और उत्तर भी शामिल करें।"
            )
